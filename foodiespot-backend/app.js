...
client.collectDefaultMetrics({ register: metricsRegister, prefix: "foodiespot_" });

const httpRequestDurationSeconds = new client.Histogram({
  name: "foodiespot_http_request_duration_seconds",
...
const httpRequestsTotal = new client.Counter({
  name: "foodiespot_http_requests_total",
...
app.use((req, res, next) => {
  ...
  res.on("finish", () => {
    // req.route.path donne le pattern (ex: /restaurants/:id) plutôt que l'URL brute
